  ...
  return (
    <div className='w-full h-screen flex flex-col relative'>
        <div className='mx-auto pt-16 flex flex-col items-center gap-8 z-20 '>
            <p className='text-txtColor font-semibold text-xl'>Don't let diseases hinder your harvest. Take charge now for healthier crops and bountiful yields.</p>
            <Link to="/diseases">
                <button className='text-white bg-txtColor cursor-pointer text-2xl hover:bg-btnColor hover:font-semibold rounded-full w-60 h-16 '>Diagnose here</button>
            </Link>
        ...
        >
         <div className='absolute bottom-52 left-0 ml-20 '>
